...
5 Pkt.
*/
SELECT last_name AS Nachname, first_name AS Vorname, email AS Email
FROM customer
ORDER BY last_name;
...
SELECT *
FROM actor
WHERE first_name = 'BOB' OR first_name = 'CAMERON';
...
SELECT *
FROM actor
WHERE first_name IN ('REESE', 'PENELOPE') AND NOT last_name = 'GUINESS';
